/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 31af996a2c5bbfcd1814a3b513063437)
// Runtime types generated with workerd@1.20260911.1 2026-09-11 enable_request_signal,global_fetch_strictly_public,nodejs_compat,request_signal_passthrough
interface __BaseEnv_Env {
	ASSET: Fetcher;
	NODE_ENV: 'production';
	CF_OAUTH_ID: '313e2ae257d550c979da3c6d868ab053';
	AUTH_SECRET: string;
	CF_OAUTH_SECRET: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, 'NODE_ENV' | 'CF_OAUTH_ID' | 'AUTH_SECRET' | 'CF_OAUTH_SECRET'>> {}
}
